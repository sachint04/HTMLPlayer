define([
	...
	/*'core/CourseController',*/
	'util/StringUtil',
	'util/MessageLogger'
], function($, EventDispatcher/*, CourseController*/, StringUtil, Logger) {
	...
	AbstractUIComponent.prototype.dispatchEvent						= function(p_sEventToDispatch, p_oEventObject){
		...
		//this.dispatchEvent('UPDATE', p_oEventObject);
	};
	/*
	...
	AbstractUIComponent.prototype.toString							= function() {
		return 'view/AbstractUIComponent';
	};
