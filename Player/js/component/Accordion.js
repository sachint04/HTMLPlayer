define(['jquery', 'component/AbstractComponent', 'util/EventDispatcher'], function($, AbstractComponent, EventDispatcher) {
	...
	Accordion.prototype.setSelectedPage = function(p_oTarget) {
		if (!this.oBoard)
			return null;
	...
	Accordion.prototype.getSelectedPageIndex = function() {
		return this._selectedPageIndex;
	};

	Accordion.prototype.getCurrentPage = function() {
		if (!this.oBoard)
			return null;
		var oPage = null;
		if (this.sSectionTitle == "Board") {
	...
	Accordion.prototype.getBoardName = function(p_sType) {
		if (!this.oBoard)
			return null;
