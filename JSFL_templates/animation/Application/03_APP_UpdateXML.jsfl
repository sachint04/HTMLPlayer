...
function getSwiffyData(htmlData){
	...
	//sSwiffyData.lastIndexOf(']') === sSwiffyData.length
	fl.trace('Index of ] = '+sSwiffyData.lastIndexOf(']'));
	fl.trace('Swiffy Data Length= '+sSwiffyData.length);
...
function init(){
	...
	sHTMLData += '<div id="content" class="page-content APP swiffy-page">';
